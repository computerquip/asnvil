...
fn test_algorithm_identifier_roundtrip() {
    ...
    println!("PASS: AlgorithmIdentifier roundtrip");
}
...
fn test_validity_roundtrip() {
    ...
    println!("PASS: Validity roundtrip");
}
...
fn test_name_roundtrip() {
    ...
    let name = Name { r#type: rdn_seq }; // Note: generated struct might use 'type' or 'rdnSequence'
