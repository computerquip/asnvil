...
pub enum AsnType {
    ...
    Integer { named_numbers: Option<Vec<NamedNumber>>, constraint: Option<Constraint>, span: SourceSpan },
    Real { span: SourceSpan },
    Enumerated { items: Vec<EnumItem>, extensible: bool, ext_items: Vec<EnumItem>, span: SourceSpan },
    BitString { named_bits: Option<Vec<NamedBit>>, constraint: Option<Constraint>, span: SourceSpan },
    OctetString { constraint: Option<Constraint>, span: SourceSpan },
    ...
    RestrictedString { charset: CharsetType, constraint: Option<Constraint>, span: SourceSpan },
    UnrestrictedString { constraint: Option<Constraint>, span: SourceSpan },
